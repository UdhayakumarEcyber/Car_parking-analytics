...
APIKEY="$2"
URL="$1"
curl  -X POST $URL/Lucy/CarPark/carparks  -H "Authorization: APIKEY $APIKEY" -H "Content-Type: application/json"  --data "{ \"carparks\": [{\"name\":\"Level1\",\"capacity\":\"200\"},{\"name\":\"Level2\",\"capacity\":\"150\"},{\"name\":\"Level3\",\"capacity\":\"150\"}] }"
occ1=$((150 + $RANDOM % 50))
occ2=$((100 + $RANDOM % 70))
occ3=$((100 + $RANDOM % 70))
